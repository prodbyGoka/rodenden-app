    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Нешто не тргна како треба. Освежи ја страницата или врати се дома.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Организатор на роденден" },
      {
        name: "description",
        content: "Лични линкови за покана, одговори од гостите и распоред на седишта во автобусот.",
      },
      { property: "og:title", content: "Организатор на роденден" },
      {
